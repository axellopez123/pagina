...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="row align-items-start">
        ...
        <div class="carousel-inner">
            ...
            <img src="{{ asset('public/img/1.png') }}" class="d-block carrou" alt="...">
            ...
            <img src="{{ asset('public/img/2.png') }}" class="d-block carrou" alt="...">
            <div class="carousel-caption d-none d-md-block">
            ...
            <img src="{{ asset('public/img/3.png') }}" class="d-block carrou" alt="...">
            <div class="carousel-caption d-none d-md-block">
