...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="row align-items-start">
        ...
        <div class="carousel-inner">
            ...
            <img src="{{ asset('img/favicon.png') }}" class="d-block w-100" alt="...">
    ...
    <div><p class="fw-bolder text-center">SERVICIOS</p></div>
        ...
        <div class="col">
        <img src="{{ asset('img/estadistica.jpg') }}" class="img-fluid" alt="...">
        <p class="fw-bolder text-center">Estadística Empresarial</p>
        </div>
    </div>
    <div class="row align-items-center">
     ...
     <p class="fw-bolder text-center">CONTACTO</p>
        ...
        <div class="row justify-content-evenly">
            <div class="mb-3">
                ...
                <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="Juan Pérez">
            </div>
            <div class="mb-3">
